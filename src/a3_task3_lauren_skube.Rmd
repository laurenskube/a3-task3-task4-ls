...
The graph for purple urchins is left skewed and has a central tendency of 4.47 cm. The graph for red urchins is closer to a normal distribution (symmetric) and has a central tendency of 6.78 cm. The difference in mean urchin diameter for purple urchins and red urchins is 2.307 cm, and the percent difference is 34.04%.The range of red urchin diameter measurements is larger than the range of purple urchin diameter measurements because the graph for red urchins is wider and more spread along the x-axis, whereas the graph for purple urchins is more narrow. 
...
```{r}
purple_summary <- purple_urchins %>% # create a table containing the number of purple urchins per sute and year
